...
public class AppointmentServiceImpl implements AppointmentService {
	...
	public List<AppointmentDTO> findAppointments() {
		List<Appointment> appointmentList = (ArrayList<Appointment>) appointmentRepository.findAllByOrderByIdDesc();
		...
		for (Appointment appointment : appointmentList) {
			...
			appointmentDTO.setModifiedDateTime(appointment.getDateTime());
