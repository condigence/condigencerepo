$('#addAppointmentform').formValidation({
	...
	fields : {
		...
		function(e) {
			...
			var firstName = $(".add_appointment_firstName").val();
			var lastName = $(".add_appointment_lastName").val();
			var age = $(".add_appointment_age").val();
			var address = $(".add_appointment_address").val();
			var contactNo = $(".add_appointment_contact").val();
			var gender = $(".add_appointment_gender option:selected").text();
			var email = $(".add_appointment_email").val();
			var referredByDoctorId = $(".add_appointment_referredByDoctorId option:selected")
					.val();
					...
					fields : {
						add_doctor_name : {
							validators : {
								 ...
								 * 'The username must be more than 6 and less
